// Esto es el codigo, revisar a medida que lo voy modificando
...
def project = ComponentAccessor.getProjectManager().getProjectByCurrentKey("TES")
...
def fin = '''
	...
	<h1> Values from custom fields TES </h1>
    <hr/>
